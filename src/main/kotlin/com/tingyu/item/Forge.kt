...
object Forge {
    ...
    fun init() {
        // 武器核心材料
        WEAPON_CORE_3 = DewItem.reg(Material.CLAY_BALL, "§b赤铜锭", "weapon_core_3", R3, "§7§o用来制作三阶武器核心的材料", "§7§o非常珍贵,可以到铁匠铺进行锻造") { shiny() }.maxStack(99)
        WEAPON_CORE_4 = DewItem.reg(Material.QUARTZ, "§b玄铁锭", "weapon_core_4", R4, "§7§o用来制作四阶武器核心的材料", "§7§o非常珍贵,可以到铁匠铺进行锻造") { shiny() }.maxStack(99)
        WEAPON_CORE_5 = DewItem.reg(Material.DIAMOND, "§b灵玉简", "weapon_core_5", R5, "§7§o用来制作五阶武器核心的材料", "§7§o非常珍贵,可以到铁匠铺进行锻造") { shiny() }.maxStack(99)

        // 装备原核
        ARMOR_CORE_3 = DewItem.reg(Material.IRON_NUGGET, "§b三阶装备原核", "armor_core_3", R3, "§7§o用来制作三阶装备核心的材料", "§7§o可以锻造成指定的三阶套装核心") { shiny() }.maxStack(99)
        ARMOR_CORE_4 = DewItem.reg(Material.IRON_NUGGET, "§b四阶装备原核", "armor_core_4", R4, "§7§o用来制作四阶装备核心的材料", "§7§o可以锻造成指定的四阶套装核心") { shiny() }.maxStack(99)
        ARMOR_CORE_5 = DewItem.reg(Material.IRON_NUGGET, "§b五阶装备原核", "armor_core_5", R5, "§7§o用来制作五阶装备核心的材料", "§7§o可以锻造成指定的五阶套装核心") { shiny() }.maxStack(99)
