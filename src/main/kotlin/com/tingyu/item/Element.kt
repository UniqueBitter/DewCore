...
import com.tingyu.command.DewItem.Companion.R1
...
object Element {
    ...
    fun init() {
        ...
        // ================== [ 1. 基础元素 (R1) ] ==================
        ELEMENT_METAL = DewItem.reg(Material.EMERALD, "§f金元素", "element_metal", R1, elementLore).maxStack(99)
        ELEMENT_WOOD = DewItem.reg(Material.BONE, "§f木元素", "element_wood", R1, elementLore).maxStack(99)
        ELEMENT_WATER = DewItem.reg(Material.STRING, "§f水元素", "element_water", R1, elementLore).maxStack(99)
        ELEMENT_FIRE = DewItem.reg(Material.BLAZE_ROD, "§f火元素", "element_fire", R1, elementLore).maxStack(99)
        ELEMENT_EARTH = DewItem.reg(Material.MAGMA_CREAM, "§f土元素", "element_earth", R1, elementLore).maxStack(99)

        // ================== [ 2. 精炼元素 (R3) ] ==================
        ELEMENT_METAL_REFINED = DewItem.reg(Material.EMERALD, "§b精炼金元素", "element_metal_refined", R3, "§7§o经过简单提纯后的金之元素"){ shiny() }.maxStack(99)
        ELEMENT_WOOD_REFINED = DewItem.reg(Material.BONE, "§b精炼木元素", "element_wood_refined", R3, "§7§o经过简单提纯后的木之元素"){ shiny() }.maxStack(99)
        ELEMENT_WATER_REFINED = DewItem.reg(Material.STRING, "§b精炼水元素", "element_water_refined", R3, "§7§o经过简单提纯后的水之元素"){ shiny() }.maxStack(99)
        ELEMENT_FIRE_REFINED = DewItem.reg(Material.BLAZE_ROD, "§b精炼火元素", "element_fire_refined", R3, "§7§o经过简单提纯后的火之元素"){ shiny() }.maxStack(99)
        ELEMENT_EARTH_REFINED = DewItem.reg(Material.MAGMA_CREAM, "§b精炼土元素", "element_earth_refined", R3, "§7§o经过简单提纯后的土之元素"){ shiny() }.maxStack(99)
